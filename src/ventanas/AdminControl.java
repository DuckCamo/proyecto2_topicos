...
public class AdminControl extends javax.swing.JFrame {
        ...
        jTable_admins.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(fila_point > -1){
                    ...
                    UserInfo userinfo = new UserInfo(user_update);
    ...
    private void Tabla(){
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement(
                    "select id, name, lastnamef, lastnamem, age, phonenumber from users where typeofuser = 'Administrador'");
    ...
    private void initComponents() {
        ...
        jLabel_User3.setText("Agregar Administrador");
        ...
        jLabel_welcome.setText("Control de Administradores");
        getContentPane().add(jLabel_welcome, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 20, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new AddUser("Administrador").setVisible(true);
